...
export class Tick extends Entity {
  constructor(id: string) {
    ...
    this.set("createdAtBlockNumber", Value.fromBigInt(BigInt.zero()));
    this.set("liquidityProviderCount", Value.fromBigInt(BigInt.zero()));
    this.set("feeGrowthOutside0X128", Value.fromBigInt(BigInt.zero()));
    this.set("feeGrowthOutside1X128", Value.fromBigInt(BigInt.zero()));
  }
...
export class Position extends Entity {
  constructor(id: string) {
    ...
    this.set("liquidity", Value.fromBigInt(BigInt.zero()));
    this.set("depositedToken0", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("depositedToken1", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("withdrawnToken0", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("withdrawnToken1", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("collectedFeesToken0", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("collectedFeesToken1", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("amountDepositedUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("amountWithdrawnUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("amountCollectedUSD", Value.fromBigDecimal(BigDecimal.zero()));
